...
Jobs_File = open('/Users/bkirkham/FinalProject/jobs_data.json')
...
for job in Jobs_Data:
    ...
    Jobs_Test_Clean = str(job['Description'])

    # regex to replace html elements with two spaces
    ...
    Jobs_Test_Clean = Jobs_Test_Clean.lower()
    ...
    Jobs_Test_Clean = [x.strip() for x in Jobs_Test_Clean]
    ...
    for word in Jobs_Test_Clean:
        ...
        if "+" in word:
            if word != "c++":
                continue
                # if word in Jobs_Test_Clean:
                #     Jobs_Test_Clean.remove(word)
    ...
    # print(final_jobs)
    Jobs_Test_Clean = {'Company': job['Company'], 'Description': final_jobs}
    # print(Jobs_Test_Clean)
    Job_Words_Lists.append(Jobs_Test_Clean)

    # print(Jobs_Data[i]['Description'])

# print(len(Job_Words_Lists))
...
clean_jobs_data = json.dumps(Job_Words_Lists, indent=2)

with open("/Users/bkirkham/FinalProject/clean_jobs_data.json", "w") as out:
    out.write(clean_jobs_data)